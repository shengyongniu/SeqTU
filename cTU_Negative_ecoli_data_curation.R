...
library(gridBase)
library(ggplot2)
source("/Users/syniu/Desktop/SeqTU/SeqTU_dev/tools/scripts/seqTU_functions_041114.r")

vplayout <- function(x, y) viewport(layout.pos.row = x, layout.pos.col = y)

file_RNAseqSignals <- "Ecoli.NA"
fileNamePrefix <- "test"
file_gff <- "GCF_000005845.2_ASM584v2_genomic.gff"
file_genomeSequence <- "GCF_000005845.2_ASM584v2_genomic.fna"
